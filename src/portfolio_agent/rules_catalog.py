...
RULES: tuple[StrategyRule, ...] = (
    ...
    StrategyRule(
        "CORE_DCA_SEPARATION",
        "Separate scheduled DCA from tactical timing",
        "Investment process",
        "core_dca_action is independent of tactical_action",
        "Continue scheduled long-term contributions when the written horizon and risk plan are unchanged.",
        "Moving-average timing manages tactical exposure; it does not prove that withholding every scheduled contribution improves return.",
        "Vanguard research distinguishes regular investing from deliberately holding an available lump sum in cash.",
        "implemented",
        "https://investor.vanguard.com/investor-resources-education/online-trading/dollar-cost-averaging-vs-lump-sum",
    ),
    StrategyRule(
        "RISING_50DMA_PULLBACK",
        "Rising 50-day pullback entry",
        "Tactical entry",
        "price >= SMA50 > SMA200 with positive slopes, recent SMA50 test, and RSI between 35 and 65",
        "Permit only a staged tactical add; do not treat strong momentum far above the 50-day average as an immediate entry.",
        "A controlled pullback can improve entry discipline while preserving the established long-term trend.",
        "Transparent proxy based on public RIA discussion; not the proprietary RIA money-flow model.",
        "implemented",
        "https://realinvestmentadvice.com/resources/blog/bull-market-pullback-why-the-4-5-dip-held-the-50-dma/",
    ),
    StrategyRule(
        "CONFIRMED_200DMA_BREAK",
        "Confirmed 200-day break",
        "Tactical risk reduction",
        "price < SMA200 and at least 3 confirmations from SMA200 slope, SMA50/SMA200 stack, weekly MACD, and sector breadth",
        "Reduce only the tactical sleeve after confirmation; do not liquidate the core portfolio from one daily close.",
        "The 200-day average is a lagging regime indicator whose false breaks require context and confirmation.",
        "Transparent proxy based on public RIA discussion; exact thresholds are this project's rules.",
        "implemented",
        "https://realinvestmentadvice.com/resources/blog/the-200-dma-just-broke-what-every-investor-should-know/",
    ),
    StrategyRule(
        "Z_EXTREME_BANDS",
